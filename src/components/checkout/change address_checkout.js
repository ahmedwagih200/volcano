...
export default function Cheackout_address() {
    const {
      ...
      const { first_name, last_name, email, address,building_number,floor_number,apartment_number,landmark, phone } = formData;
      ...
      const updateUserData = () => {
        ...
        const body = JSON.stringify({ first_name, last_name, email, address,building_number,floor_number,apartment_number,landmark, phone});
  ...
  return (
    ...
    <Card className="Card shadow-lg">
      ...
      <form onSubmit={e => onSubmit(e)}>
                ...
                <button style={{ marginLeft: '5px' }} className="btn btn-dark mt-3" type='submit'>    <Link to='/checkout'>Back</Link></button>
